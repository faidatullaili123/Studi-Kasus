...
<body>
    ...
    <table  id="mytable" class="display" cellpadding="10" cellspacing="0" class="table table-striped">
     <a href="create-katalog.php" class="btn btn-primary mt-4 mb-4">Tambah data</a>
        <thead>
            <tr>
        ...
        ?>
        <tr>
            <td class="text-center"><?php echo $katalog['id_katalog'] ?></td>
            <td class="text-center"><?php echo $katalog['nama'] ?></td>
            <td class="text-center">
            <a  class="btn btn-warning" href="edit-katalog.php?id_katalog=<?= $katalog['id_katalog']; ?>">Edit</a>
            <a  class="btn btn-danger" href="delete-katalog.php?id_katalog=<?= $katalog['id_katalog']; ?> " onclick="return confirm('Yakin dihapus')">Delete</a>
        </tr>
        <?php 
            } 
        ?>
